...
function VendorDashboard() {
  ...
  // on dashboard load rather than shared state. This will be removed once
  // this component migrates onto DashboardContext directly, in a later
  // commit in this same cleanup session.
